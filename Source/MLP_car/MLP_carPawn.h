...
#include "MLP_carPawn.generated.h"
...
UCLASS(config=Game)
class AMLP_carPawn : public AWheeledVehicle
{
	GENERATED_BODY()
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, meta = (AllowPrivateAccess = "true"),Category = "Pio")
